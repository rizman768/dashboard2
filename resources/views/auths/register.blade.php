                                    ...
                                    <div class="card-body">
                                        <form action="/storeregister" method="post">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="" name ="nama" type="text" placeholder="Enter your first name" />
                                            ...
                                            <div class="text-center mt-4 mb-0">
                                                <div class="d-grid"><a> <button class="btn btn-primary btn-block" type="submit">Create Account</button></a></div>
                                            </div>
                                        </form>
                                    </div>
